...
export default function CreatePost() {
  ...
  async function handleSubmit(event) {
    ...
    if (
      (postDescription.length < 32 || postDescription.length > 8192) &&
      isTypeText
    ) {
  ...
  return (
    <Container
      ...
      style={{ minHeight: "100vh", maxWidth: "60%", marginLeft: "0" }}
    >
