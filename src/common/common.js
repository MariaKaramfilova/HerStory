...
export const HOME_PAGE_MESSAGE =
  "Women`s Human Rights Forum: A place to connect, learn and act for gender equality. Join us today and be part of the change. 💜";
...
export const MISSING_VOTED_BY_MESSAGE =
...
export const SUCCESS_REGISTER_MESSAGE =
  "Congratulations! You have created an account on the HerStory forum!";
